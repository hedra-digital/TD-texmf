...
\item \textit{Perversão: a forma erótica do ódio}, R.J. Stoller
\item \textit{A vênus de quinze anos}, [Swinburne]
\item \textit{Explosão}, Hubert Fichte
\item \textit{Do amor e outras brutalidades}, Anna P. (no prelo)
\item \textit{A invenção da pornografia}, Lynn Hunt (no prelo)
